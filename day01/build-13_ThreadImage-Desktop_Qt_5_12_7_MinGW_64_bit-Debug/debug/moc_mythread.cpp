...
#include "../../13_ThreadImage/mythread.h"
...
QT_MOC_LITERAL(3, 22, 4) // "temp"

    },
    "MyThread\0updateImage\0\0temp"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyThread::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::updateImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::updateImage(QImage _t1)
{
